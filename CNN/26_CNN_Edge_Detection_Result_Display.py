# ------------------------------------------------------------
# Kishor Convolution Demo with Visualization
# 6x6 Grayscale Image
# Top 3 rows = 0
# Bottom 3 rows = 255
...
# ------------------------------------------------------------
def Kishor_Print_Matrix(title, matrix):
    print("\n" + "-" * 50)
    print(title)
    print("-" * 50)
    print(matrix)
...
Kishor_Print_Matrix("Original 6x6 Image", image)
...
Kishor_Print_Matrix("3x3 Edge Detection Kernel", kernel)
...
for i in range(4):
    for j in range(4):
        ...
        Kishor_Print_Matrix("Current 3x3 Region from Image", region)

        # Element-wise multiplication
        multiplied = region * kernel
        Kishor_Print_Matrix("Region * Kernel", multiplied)
        ...
        Kishor_Print_Matrix("Feature Map Built So Far", feature_map)

# ------------------------------------------------------------
# Step 5 : Final Feature Map
# ------------------------------------------------------------
Kishor_Print_Matrix("Final Feature Map", feature_map)
