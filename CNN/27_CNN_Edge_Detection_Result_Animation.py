# ------------------------------------------------------------
# Kishor Edge Detection Demo with Animation
...
# ------------------------------------------------------------
def Kishor_Draw_Values(ax, matrix, text_color="black"):
...
Kishor_Print_Matrix("3x3 Kernel", kernel)
...
for i in range(4):
    for j in range(4):
        ...
        Kishor_Draw_Values(axes[0], image)
        ...
        Kishor_Draw_Values(axes[1], region)
        ...
        Kishor_Draw_Values(axes[2], kernel)
        ...
        Kishor_Draw_Values(axes[3], feature_map)
