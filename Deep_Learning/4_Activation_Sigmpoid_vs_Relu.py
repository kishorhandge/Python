...
# Author  : Handge Kishor Suryabhan
# ---------------------------------------------------------
...
def Kishor_neuron_forward(inputs, weights, bias, activation_func):
...
def main():
    ...
    Kishor_neuron_forward(inputs, weights, bias, sigmoid)

    # ReLU neuron
    print("=== ReLU Neuron ===")
    Kishor_neuron_forward(inputs, weights, bias, relu)
