...
# ---------------------------------------------------------
# Kishor ANN Example with Animated Graphics
# Demonstrates:
...
def Kishor_Sigmoid_Derivative(output):
...
for epoch in range(1, epochs + 1):
    ...
    doutput_dz = Kishor_Sigmoid_Derivative(output)
...
def update(frame):
    ...
    # Title
    ax.text(5.5, 9.5, "Kishor ANN Training Animation", ha='center',
