...
# Output Range  : 0 to 1
# ---------------------------------------------------------
def Kishor_Sigmoid(value):
    return 1 / (1 + math.exp(-value))


# ---------------------------------------------------------
# Function Name : Kishor_Calculate_Weighted_Sum
...
# ---------------------------------------------------------
def Kishor_Calculate_Weighted_Sum(inputs, weights, bias):
    weighted_sum = sum(weight * input_value for weight, input_value in zip(weights, inputs)) + bias
    return weighted_sum


# ---------------------------------------------------------
# Function Name : Kishor_Display_Multiplication_Details
...
#   weights -> List of weights
# ---------------------------------------------------------
def Kishor_Display_Multiplication_Details(inputs, weights):
...
# ---------------------------------------------------------
# Function Name : Kishor_Process_Hidden_Layer
...
# ---------------------------------------------------------
def Kishor_Process_Hidden_Layer(inputs, hidden_weights, hidden_biases):
    hidden_outputs = []
    ...
    for neuron_index in range(len(hidden_weights)):
        ...
        Kishor_Display_Multiplication_Details(inputs, current_weights)

        # Calculate weighted sum
        z_value =Kishor_Calculate_Weighted_Sum(inputs, current_weights, current_bias)
        print(f"  Step 2: Add all multiplication results and bias {current_bias}")
        print(f"    z = {z_value:.3f}")

        # Apply ReLU activation
        activated_output =Kishor_ReLU(z_value)
...
# ---------------------------------------------------------
# Function Name : Kishor_Process_Output_Layer
...
# ---------------------------------------------------------
def Kishor_Process_Output_Layer(hidden_outputs, output_weights, output_bias):
    print("\n================ OUTPUT LAYER ================\n")
    ...
    z_output = Kishor_Calculate_Weighted_Sum(hidden_outputs, output_weights, output_bias)
    print(f"  Step 2: Add all multiplication results and bias {output_bias}")
    print(f"    z = {z_output:.3f}")

    # Apply Sigmoid activation
    final_output =Kishor_Sigmoid(z_output)
...
# ---------------------------------------------------------
# Function Name :Kishor_ANN_Forward_Pass
...
# ---------------------------------------------------------
def Kishor_ANN_Forward_Pass(inputs):
    print("================ INPUT LAYER ================\n")
    ...
    hidden_outputs =Kishor_Process_Hidden_Layer(
        inputs,
        hidden_weights,
        hidden_biases
    )
    ...
    z_output, final_output =Kishor_Process_Output_Layer(
        hidden_outputs,
        output_weights,
        output_bias
    )
    ...
    # Display summary
    Kishor_Display_Network_Summary(hidden_outputs, final_output)
...
def main():
    ...
    Kishor_ANN_Forward_Pass(inputs)
